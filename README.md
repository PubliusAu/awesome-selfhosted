...
- [Arize Phoenix](https://phoenix.arize.com) - AI engineering platform from Arize team that helps boost coding agent and AI accuracy with prompt learning, evals, and observability ([Demo](https://www.youtube.com/watch?v=kf2MU0MNHqQ), [Source Code](https://github.com/Arize-ai/phoenix), [Comparison](https://arize.com/llm-evaluation-platforms-top-frameworks), [Clients](https://arize.com/docs/phoenix/integrations)) `Elastic License 2.0` `Docker`
